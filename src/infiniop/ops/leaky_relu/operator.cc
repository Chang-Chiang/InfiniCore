...
__C infiniStatus_t infiniopCreateLeakyReluDescriptor(
    ...
    infiniopTensorDescriptor_t negative_slope_desc) {
...
#define CALCULATE(CASE, NAMESPACE)                                                   \
    case CASE:                                                                       \
        return reinterpret_cast<const op::leaky_relu::NAMESPACE::Descriptor *>(desc) \
            ->calculate(workspace, workspace_size, y, {x, negative_slope}, stream)
...
__C infiniStatus_t
infiniopDestroyLeakyReluDescriptor(infiniopLeakyReluDescriptor_t desc) {
